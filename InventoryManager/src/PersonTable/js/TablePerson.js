...
personTableF.initTable = () => {
    ...
    personTableF.personTable.addAction({ css: "fa fa-pencil", redirectTo: "IndexPerson.html", alt: "Edit" });
    personTableF.personTable.addAction({ css: "fa fa-bars", redirectTo: "IndexPerson.html", alt: "Details" });
    personTableF.personTable.addAction({ css: "fa fa-trash red", redirectTo: "IndexPerson.html", alt: "Delete" });
    personTableF.personTable.addAction({ css: "fa fa-search", redirectTo: "IndexPerson.html", alt: "View" });
